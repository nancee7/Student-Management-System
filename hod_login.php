...
<p class="pull-right"> <button type="button" class="btn btn-link">ADMIN-LOGIN</button> </p>
 ...
 <div class="container" >
	   ...
	   <form class="" role="form" method="post" action="hod_login_conff.php">   
	        <div class="row form-group">
	 	       <div class="col-md-4 col-md-offset-4">
	 		        <div class="login-panel panel panel-default">
	 			              <div class="panel-heading">
	 				
	 				         <h1 class="panel-title"><center>HOD LOGIN</center></h1>
	 			             </div>
	 			...
	 			<fieldset >
                   <div class="form-group" >
         	           <input class="form-control" placeholder="staff-id" id="staff_id" name="staff_id" type="text" size="15" autofocus required/>
                    </div>
